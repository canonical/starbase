...
.PHONY: lint
lint: lint-ruff lint-ty lint-pyrefly lint-codespell lint-mypy lint-prettier lint-pyright lint-shellcheck lint-docs lint-twine lint-uv-lockfile  ## Run all linters
